public class BSTDriver_11_10 {
    public static void main(String[] args) {
        BST_11_10 theTree = new BST_11_10();
    ...
    public static void inORderTravsTree( BSTNode_11_10 focusNode ){
    ...
    public static void postORderTravsTree( BSTNode_11_10 focusNode ) {
    ...
    public static void preOrderTravsTree( BSTNode_11_10 focusNode ) {
        if ( focusNode != null){
            System.out.printf( "\n%s", focusNode.key);
